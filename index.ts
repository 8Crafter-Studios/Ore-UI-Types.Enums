...
export type ThirdPartyServersStatus<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof ThirdPartyServersStatus,
    Mode
>;
...
export type SettingsComponentState<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof SettingsComponentState,
    Mode
>;
...
export type GeneralMultiplayerWarningStateEnum<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof GeneralMultiplayerWarningStateEnum,
    Mode
>;
...
export type ExperimentalFeatureCategory<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof ExperimentalFeatureCategory,
    Mode
>;
...
export type JoinServerWorldResult<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof JoinServerWorldResult,
    Mode
>;
...
export type PlayerMessagingServiceFacetStatus<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof PlayerMessagingServiceFacetStatus,
    Mode
>;
...
export type PlayerPermissionsAbility<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof PlayerPermissionsAbility,
    Mode
>;
...
export type PlayerPermissionsError<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof PlayerPermissionsError,
    Mode
>;
...
export type StartLocalWorldResult<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof StartLocalWorldResult,
    Mode
>;
...
export type PlayerPermissionsActionState<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof PlayerPermissionsActionState,
    Mode
>;
...
export type ProfanityFilterContext<Mode extends "enum" | "keys" | "values" = "enum"> = ConstNumberObjectEnumToEnumMappingType<
    typeof ProfanityFilterContext,
    Mode
>;
